document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        errorFetchFailed: {zh: "Fogsight服务不可用，请确保后端服务正在运行", en: "Fogsight service is unavailable. Please ensure the backend service is running."},
        errorTooManyRequests: {zh: "今天已经使用太多，请明天再试", en: "Too many requests today. Please try again tomorrow."}
    };

    let currentLang = config.defaultLang;
    const container = document.getElementById('fogsight-container');
    ...
    function switchToChatView() {
        container.classList.remove('show-initial-view');
        container.classList.add('show-chat-view');
    ...
    function init() {
        container.classList.add('show-initial-view');
        ...
        modalGitHubButton.addEventListener('click', () => {
            window.open('https://github.com/fogsightai/fogsight', '_blank');
            hideModal();
        });
