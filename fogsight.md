---
layout: page
title: "Fogsight AI Animation Generator"
---

<div id="fogsight-container">
    ...
    <div id="initial-view" class="initial-view">
        <img src="/static/fogsight/logo.png" alt="Fogsight Logo" class="logo" id="logo-initial">
    ...
    <div id="chat-view" class="chat-view">
        <header class="chat-header">
            ...
            <img src="/static/fogsight/logo.png" alt="Fogsight Logo" class="logo" id="logo-chat">
        </header>
...
<link rel="stylesheet" href="/static/fogsight/style.css">
<script src="/static/fogsight/script.js"></script>
